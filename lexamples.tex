% Recipe: texify --pdf --engine=xetex or latexmk -xelatex 
%         or xelatex -> bibtex -> xelatex*2
% Paper size: A4
% Font size: 10 pt
...
\usepackage{tabularray} % (Complex) Tables
\usepackage{textcomp} % Special Symbols
\usepackage{ulem} % Content Emphases
...
\end{verbatim*}
    ...
    When having trouble, use the \verb|listings| package.
    \subsection{Table}
    \begin{table}[htbp]
        \centering
        \begin{tblr}{c|cccccc}
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=0.6\textwidth]{imgs/Hakuho.jpg}
    ...
    % Here BibTeX is used.
    % You can also try natbib and biblatex.

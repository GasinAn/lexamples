% Recipe: latexmk -xelatex or xelatex -> bibtex -> xelatex*2
...
\begin{document}
    ...
    emphasis emphasis \uline{emphasis} emphasis emphasis\\
    \textit{emphasis emphasis \uline{emphasis} emphasis emphasis}\\
...
\end{verbatim*}
    ...
    (\url{https://github.com/GasinAn/lexamples}),
    or send emails to
